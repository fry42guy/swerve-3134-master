...
public class HorizontalManualMode_In extends CommandBase {
  /** Creates a new HorizontalManualMode_In. */
  public final HorizontalSubsystem m_HorizontalSubsystem;
  public HorizontalManualMode_In(HorizontalSubsystem m_HorizontalSubsystem) {
  ...
  @Override
  public void execute() {
    m_HorizontalSubsystem.setSpeed(Constants.Horizontal_Motor_Speed*-1);
  }
